...
sys.puts "3"
EMPTY.put(50, 'a').put(51, 'b').put(0, 23).forEach (v, i) -> sys.puts "#{i}: #{v}"
...
sys.puts EMPTY.put(1, 'a').put(2, 'b').put(33, 'c').dump()
sys.puts "11"
sys.puts EMPTY.put(2, 'b').put(33, 'c').put(65, 'd')
sys.puts "12"
...
sys.puts EMPTY.put(1, 'a').put(2, 'b').put(33, 'c').put(65, 'd').put(36, 'e').put(70, 'f')
sys.puts EMPTY.put(33, 'c').put(65, 'd').put(36, 'e')
sys.puts EMPTY.put(33, 'c').put(65, 'd').dump()
sys.puts EMPTY.put(33, 'c').put(65, 'd').put(36, 'e').dump()
