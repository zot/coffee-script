(function() {
  ...
  grammar = {
    ...
    Mofor: [
      o('MOFOR MoClauses TERMINATOR -> Block', function() {
        return new Mofor($2, $5);
      })
    ],
    MoClauses: [
      o('INDENT MoBind OUTDENT', function() {
        return $2;
      }), o('INDENT MoBind MoreMoClauses OUTDENT', function() {
        return $2.concat($3);
      })
    ],
    MoreMoClauses: [
      o('TERMINATOR MoBind', function() {
        return $2;
      }), o('TERMINATOR MoFilter', function() {
        return $2;
      }), o('MoreMoClauses TERMINATOR MoBind', function() {
        return $1.concat($3);
      }), o('MoreMoClauses TERMINATOR MoFilter', function() {
        return $1.concat($3);
      })
    ],
    MoBind: [
    ...
    MoFilter: [
      o('POST_IF Expression', function() {
        return [new MoFilter($2)];
      })
    ],
    Switch: [
