  ...
  grammar = {
    ...
    Mofor: [
      o('MOFOR MoBind INDENT Body OUTDENT', function() {
        return new Mofor($2, $4);
      }), o('MOFOR INDENT MoClauses INDENT Body OUTDENT OUTDENT', function() {
        return new Mofor($3, $5);
      }), o('MOFOR INDENT MoClauses OUTDENT', function() {
        return new Mofor($3, null);
      })
    ],
    MoClauses: [
