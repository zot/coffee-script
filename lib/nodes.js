(function() {
  ...
  exports.MoFilter = MoFilter = (function() {
    ...
    MoFilter.prototype.compileNode = function(o) {
      return "return " + (typeof next != "undefined" && next !== null ? '(' : '') + (this.compileChain(o)) + (typeof next != "undefined" && next !== null ? ')' : '');
    };
    MoFilter.prototype.compileChain = function(o) {
      return (this.expr.compile(o, LEVEL_LIST)) + (this.next ? ') and (' + (this.next.compile(o, LEVEL_LIST)) : '');
    };
    return MoFilter;
  })();
