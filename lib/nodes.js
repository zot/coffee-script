(function() {
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.compileNode = function(o) {
      ...
      expr = "(monad = " + (this.expression.compile(o, LEVEL_PAREN)) + ")";
      if (this.filter) {
      ...
      if (!this.next) {
        ...
        return "" + (this.returns ? 'return ' : '') + expr + "." + (!this.returns ? 'forEach' : this.last ? 'map' : 'flatMap') + "(" + (this.conditionalClosure(v, this.next, o, LEVEL_TOP)) + ")";
      }
    };
  ...
  exports.MoFilter = MoFilter = (function() {
    ...
    MoFilter.prototype.compileNode = function(o) {
      return "" + (this.filter.next ? '(' : '') + (compileChain(o)) + (this.filter.next ? ')' : '');
    };
