(function() {
  ...
  exports.Mofor = Mofor = (function() {
    ...
    Mofor.prototype.compileNode = function(o) {
      var body, code, idtN, lastJumps, num, _ref, _ref2;
      body = Expressions.wrap([this.body]);
      lastJumps = (_ref = last(body.expressions)) != null ? _ref.jumps() : void 0;
      if (lastJumps && lastJumps instanceof Return) {
        this.returns = false;
      ...
      idtN = this.tab;
      for (num = 1, _ref2 = this.numClauses; (1 <= _ref2 ? num <= _ref2 : num >= _ref2); (1 <= _ref2 ? num += 1 : num -= 1)) {
        idtN += TAB;
      }
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.link = function(slice, body) {
      while (slice.length > 0 && slice[0] instanceof MoFilter) {
    ...
    MoBind.prototype.compileNode = function(o) {
      var code, expr, filt;
      if (!this.variable || this.variable === '_') {
        this.variable = o.scope.freeVariable('_');
      }
      expr = this.expression.compile(o, LEVEL_LIST);
