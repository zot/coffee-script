(function() {
  ...
  exports.Mofor = Mofor = (function() {
    ...
    function Mofor(clauses, body) {
      ...
      this.firstClause.link(clauses.slice(1, clauses.length), body);
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.compileNode = function(o) {
      ...
      func = "function(" + this.variable + "){" + code + "}";
      return (this.returns ? 'return ' : '') + (this.returns && !this.last ? "Monad.flatMap(" + expr + ", " + func + ")" : "" + expr + "." + (this.returns ? 'map' : 'forEach') + "(" + func + ")");
    };
    return MoBind;
  })();
