(function() {
  ...
  exports.Mofor = Mofor = (function() {
    ...
    Mofor.prototype.compileNode = function(o) {
      ...
      if (this.monad != null) {
        ...
        if (this.firstClause.contains(Closure.literalThis)) {
          func = "" + (utility('bind')) + "(" + func + ", this)";
        }
        code = "return " + (this.monad.expression != null ? this.monad.expression.compile(o, LEVEL_PAREN) : this.monad.variables) + ".reduce(" + func + ")";
      }
      return "" + (this.returns ? '' : this.tab + utility('bind') + '(function(){') + "\n" + (this.tab + TAB) + code + "\n" + (this.returns ? '' : this.tab + '}, this)()');
    };
    return Mofor;
  })();
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.compileNode = function(o) {
      ...
      expr = "" + (this.expression.compile(o, LEVEL_PAREN));
      if (this.filter) {
