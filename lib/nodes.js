(function() {
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.compileNode = function(o) {
      ...
      moUnit = this.reduce && !(this.next instanceof MoBind);
      return "" + (this.returns ? 'return ' : '') + expr + "." + (!this.returns ? 'forEach' : moUnit ? 'unit' : this.reduce ? 'reduce' : this.last ? 'map' : 'flatMap') + "(" + (this.conditionalClosure(this.reduce, v, this.next, this.next.compile(o, LEVEL_TOP))) + (moUnit ? '()' : this.reduce ? ', ' + this.reduceVar : '') + ")";
    };
