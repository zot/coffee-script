(function() {
  ...
  exports.Mofor = Mofor = (function() {
    ...
    function Mofor(monad, clauses, body) {
      ...
      this.returns = false;
      if (this.monad != null) {
        this.firstClause.useReduce(this.monad.variables[0]);
      }
    }
    ...
    Mofor.prototype.compileNode = function(o) {
      ...
      if (this.monad != null) {
        func = "function(" + this.monad.variables[0] + ", " + (o.scope.freeVariable('i')) + "){" + code + "}";
        if (this.firstClause.contains(Closure.literalThis)) {
          func = "" + (utility('bind')) + "(" + func + ", this)";
        }
        code = "return " + (this.monad.expression != null ? this.monad.expression.compile(o, LEVEL_PAREN) : this.monad.variables[0]) + ".reduce(" + func + ")";
      }
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.useReduce = function(rvar) {
      ...
      if (this.next instanceof MoBind) {
        return (_ref = this.next) != null ? _ref.useReduce(rvar) : void 0;
      }
    };
