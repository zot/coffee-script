(function() {
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.compileNode = function(o) {
      ...
      if (this.filter) {
        expr = "" + expr + ".filter(" + (this.conditionalClosure(v, this.filter, o, LEVEL_PAREN)) + ")";
      }
      if (!this.next) {
        return "" + (this.returns ? 'return ' : '') + expr;
      }
      return "" + (this.returns ? 'return ' : '') + expr + "." + (!this.returns ? 'forEach' : this.reduce ? 'reduce' : this.last ? 'map' : 'flatMap') + "(" + (this.conditionalClosure(v, this.next, o, LEVEL_TOP)) + (this.reduce ? ', ' + this.reduceVar : '') + ")";
    };
    MoBind.prototype.conditionalClosure = function(v, n, o, level) {
      var str;
      str = "function(" + (this.reduce ? this.reduceVar + ', ' + v : v) + "){" + (n.compile(o, level)) + "}";
