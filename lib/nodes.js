(function() {
  ...
  exports.MoBind = MoBind = (function() {
    ...
    MoBind.prototype.compileNode = function(o) {
      ...
      return "" + (this.returns ? 'return ' : '') + expr + "." + (!this.returns ? 'forEach' : moMap ? 'map' : this.reduce ? 'reduce' : this.last ? 'map' : 'flatMap') + "(" + (this.conditionalClosure(this.reduce, v, this.next, this.next.compile(o, LEVEL_TOP))) + (moMap ? '()' : this.reduce ? ', ' + this.reduceVar : '') + ")";
    };
